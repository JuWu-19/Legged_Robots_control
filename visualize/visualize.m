...
function visualize(q, r0)
    ...
    lw = 2;
    % links
    plot([x0, x_h], [z0, z_h], 'b', 'linewidth', lw); 
    hold on
    plot([x_h, x_t], [z_h, z_t], 'r', 'linewidth', lw); 
    plot([x_h, x_swf], [z_h, z_swf], 'g', 'linewidth', lw);
    ...
    % point masses
    mz = 40;
    plot(x1, z1, '.b', 'markersize', mz); 
    hold on
    plot(x2, z2, '.g', 'markersize', mz); 
    plot(x3, z3, '.r', 'markersize', mz);
end
